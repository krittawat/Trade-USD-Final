# -*- coding: utf-8 -*-
"""
XAU Strategy Tournament - Per-strategy backtest on Gold.

Usage:
  cd D:/VibeCode/Trade
  python backend/scripts/backtest_xau_tournament.py --symbol XAUUSDm --bars 18640
"""
...
def main():
    parser = argparse.ArgumentParser(description="XAU Strategy Tournament")
    ...
    print("\n" + "#" * 72)
    print("  XAU STRATEGY TOURNAMENT (PER-STRATEGY)")
    ...
    print("\n" + "=" * 88)
    print(f"  XAU TOURNAMENT RESULTS ({args.symbol}, {args.tf}, {args.bars} bars)")
    print("=" * 88)
    print(
    ...
    out_path = (
        ...
        f"xau_tournament_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
    )
