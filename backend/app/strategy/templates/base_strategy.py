...
# Optional: QuestDB param loading (graceful if not available)
_questdb_service = None
try:
    from app.services.questdb_service import questdb_service as _questdb_service
except ImportError:
    pass
